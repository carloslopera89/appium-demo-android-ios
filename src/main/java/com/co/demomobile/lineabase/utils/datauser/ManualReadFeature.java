package com.co.demomobile.lineabase.utils.datauser;

import com.co.demomobile.lineabase.exceptions.CucumberRunnerException;
...
public class ManualReadFeature {
    ...
    public static void validateScenario(Scenario scenario) {
        ...
        try {
            ...
            throw new CucumberRunnerException("Error al validar resultado de scenario Manual - " + e.getMessage(), e);
        }
    }
